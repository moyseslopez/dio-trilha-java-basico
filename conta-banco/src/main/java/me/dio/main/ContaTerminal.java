...
public class ContaTerminal {
	...
	public static void main(String[] args) {
		...
		System.out.println(message.replace("[NomeCliente]", nomeCliente).replace("[Agencia]", agencia).replace("[Numero]", String.valueOf(numero)).replace("[Saldo]", String.valueOf(saldo)));
